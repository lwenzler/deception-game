...
const instructions = magpieViews.view_generator("instructions", {
  ...
  text: `You will be taking on the  <b>role of an explorer</b>.
  You will be playing with <b>evidence</b> provided by past players, who took on the role of <b>the pirates</b>.
  <br />
  <br />
  In each round, it will be your job to <b>identify the genuine treasure map</b> out of a set of four <b>with the help of a clue</b> map provided by one of the pirates.
  This clue map is a map of the island, with blue dots indicating the location of a hidden treasure.
  ...
  The other half are <b>opposing pirates</b>, they will try to keep the treasures' locations from you.
  It is indicated in each round, who you receive the clues from.
  <br />
  <br />
  The pirates, depending on the one you are working with (teammate pirate/opposing pirate) may try to help or mislead you, therefore be aware of the kind of pirate you receive the clue from.
  None of the pirates are allowed to lie to you, so you can rule out any map where the shaded regions and the blue dots of the clue map don’t overlap.
  <br />
  <br />
...
const main_instructions = magpieViews.view_generator("instructions", {
  ...
  Remember, none of the pirates are allowed to lie to you, so you can rule out any map where the shaded regions and the blue dots of the clue map don’t overlap.
